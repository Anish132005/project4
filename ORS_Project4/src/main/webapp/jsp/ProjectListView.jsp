		...
		<center>
			...
			<table width="100%" align="center">
				<tr>
					...
					<td align="center">&emsp;<label>FirstName</font> :
					</label> <input type="text" name="FirstName" placeholder="Enter FirstName "
						value="<%=ServletUtility.getParameter("FirstName", request)%>">
					<td align="center">&emsp; <label>LastName</font> :
					 ...
					 <td align="center"><label>Dob</font> :
						...
						value="<%=ServletUtility.getParameter("Dob", request)%>">
				 		...
				 		&emsp; <label>ProjectName</font> :
					</label> <%=HTMLUtility.getList("ProjectName", String.valueOf(bean.getProjectName()), plist)%> 
...
<%= HTMLUtility.getList("ProjectName", String.valueOf(bean.getProjectName()), plist) %>
					 --%>
						...
						value="<%=ProjectListCtl.OP_SEARCH%>"> &nbsp; <input
						type="submit" name="operation" value="<%=ProjectListCtl.OP_RESET%>"></td>
				</tr>
			</table>
			<br>
