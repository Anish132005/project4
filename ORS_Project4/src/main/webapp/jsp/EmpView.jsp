...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.EMP_CTL%>" method="post">
			...
			<div align="center">
				<h1>
					...
					%>
					<tr>
						<th><font size="5px"> Employee update </font></th>
					</tr>
					<%
						} else {
					%>
			...
			<table>
				<tr>
					<th align="left">EmpName <span style="color: red">*</span> :
					</th>
					<td><input type="text" name="EmpName"
						placeholder="Enter EmpName " size="26"
						value="<%=DataUtility.getStringData(bean.getEmpName())%>"></td>
					<td style="position: fixed"><font color="red"><%=ServletUtility.getErrorMessage("EmpName", request)%></font></td>
				...
				<tr>
					...
					<td>
						<%
							...
							String hlist = HTMLUtility.getList("Company", String.valueOf(bean.getCompany()), map);
						%> <%=hlist%>
					</td>
				...
				<tr>
					...
					<td><input type="text" name="Dob"
						placeholder="Enter Dob" size="26" readonly="readonly"
						id="udatee"
				...
				<tr>
					...
					<td><input type="text" name="Salary"
						placeholder="Enter Salary " size="26"
				...
				<tr>
					...
					<td colspan="2">&nbsp; &emsp; <input type="submit"
						name="operation" value="<%=EmpCtl.OP_UPDATE%>"> &nbsp;
						&nbsp; <input type="submit" name="operation"
						value="<%=EmpCtl.OP_CANCEL%>"></td>
					...
					<td colspan="2">&nbsp; &emsp; <input type="submit"
						name="operation" value="<%=EmpCtl.OP_SAVE%>"> &nbsp;

						&nbsp; <input type="submit" name="operation"
						value="<%=EmpCtl.OP_RESET%>"></td>
