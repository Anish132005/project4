		...
		<form action="<%=ORSView.PROJECT_CTL%>" method="post">
			...
			<div align="center">
				<h1>
					...
					%>
					<tr>
						<th><font size="5px"> Project update </font></th>
					</tr>
					<%
						} else {
					%>
			...
			<table>
				<tr>
					...
					<td><input type="text" name="FirstName"
						placeholder="Enter FirstName " size="26"
				...
				<tr>
					...
					<td><input type="text" name="LastName"
						placeholder="Enter LastName " size="26"
				...
				<tr>
					...
					<td>
						<%
							...
							map.put("Project-4", "Project-4");
							map.put("Project-3", "Project-3");
							map.put("Project-10", "Project-10");

							String hlist = HTMLUtility.getList("ProjectName", String.valueOf(bean.getProjectName()), map);
						%> <%=hlist%>
					</td>
