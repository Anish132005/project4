...
public class DoctorModel {
	...
	public long add(DoctorBean bean) throws Exception {
		...
		pstmt.setString(6, bean.getFess());
		System.out.println("okyyy broooo" + bean.getFess());
	...
	public void update(DoctorBean bean) throws Exception {
		...
		PreparedStatement pstmt = conn.prepareStatement(
				"update st_doctor set Name = ?, dob = ?, Mobile = ? , expertise = ?,  fess = ? where id = ?");
