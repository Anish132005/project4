...
@WebServlet(name = "ShopListCtl", urlPatterns = { "/ctl/ShopListCtl" })
public class ShopListCtl extends BaseCtl {
	...
	System.out.println("anish...edrfgyjkl.rdtyui"+bean.getAmount());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SEARCH.equalsIgnoreCase(op)) {
			...
			if (ids != null && ids.length > 0) {
				ShopBean deletebean = new ShopBean();
				for (String id : ids) {
					...
					ServletUtility.setSuccessMessage("Shop is Deleted Successfully", request);
				}
			} else {
