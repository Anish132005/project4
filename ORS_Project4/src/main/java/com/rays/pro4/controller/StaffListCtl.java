	...
	public class StaffListCtl extends BaseCtl {
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			if (OP_SEARCH.equalsIgnoreCase(op)) {
				if (OP_SEARCH.equalsIgnoreCase(op)) {
					if (request.getParameter("identifier").equals("") && request.getParameter("fullName").equals("")
							&& request.getParameter("dob").equals("") && request.getParameter("division").equals("")
							&& request.getParameter("previousEmployer").equals("")) {
