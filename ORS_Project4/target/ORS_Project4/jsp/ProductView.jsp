		...
		<form action="<%=ORSView.PRODUCT_CTL%>" method="post">
			...
			<div align="center">
				<h1>
					...
					%>
					<tr>
						<th><font size="5px"> Product update </font></th>
					</tr>
					<%
						} else {
					%>
			...
			<table>
				<tr>
					...
					<td><input type="text" name="productName"
						placeholder="Enter productName " size="26"
				...
				<tr>
					...
					<td><input type="text" name="productPrice"
						placeholder="Enter productPrice " size="26"
						value="<%=DataUtility.getStringData(bean.getProductPrice())%>"></td>
				...
				<tr>
					<th align="left">productDate <span style="color: red">*</span>
						:
					</th>
					<td><input type="text" name="productDate"
						placeholder="Enter productDate" size="26" readonly="readonly"
						id="udatee"
						value="<%=DataUtility.getDateString(bean.getProductDate())%>"></td>
					<td style="position: fixed;"><font color="red"> <%=ServletUtility.getErrorMessage("productDate", request)%></font></td>
				</tr>
				<tr>
				<tr>
					<th style="padding: 3px"></th>
				...
				<tr>
					<th align="left">productCategory <span style="color: red">*</span> :
					</th>
					<td>
						<%
