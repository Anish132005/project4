	...
	<center>
		<form action="<%=ORSView.PORTFOLIO_CTL%>" method="post">
			...
			<table>
				...
				<tr>
					<th align="left">IntialInvestmentAmount<span style="color: red">*</span> :
					</th>
				...
				<tr>
				 ...
				 <tr>
                    <th align="left">InvestmentStrategy<span style="color: red">*</span> :</th>
                    <td>
                        <textarea name="Strategy" placeholder="Enter Strategy" rows="5" cols="25"
                            oninput="limitWords(this, 200)"><%=DataUtility.getStringData(bean.getStrategy())%></textarea>
                    </td>
                    <td style="position: fixed">
                        <font color="red"><%=ServletUtility.getErrorMessage("Strategy", request)%></font>
                    </td>
                </tr>
				<tr>
					<th style="padding: 1px"></th>
				...
				<td colspan="2">&nbsp; &emsp; <input type="submit"
					...
					<input type="submit" name="operation" value="<%=PortfolioCtl.OP_RESET%>"></td>
